...
const NoteSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'lastModifiedAt': IndexSchema(
      id: -6481729441852148349,
      name: r'lastModifiedAt',
      unique: false,
      replace: false,
      properties: [
...
void _noteSerialize(
  ...
  writer.writeDateTime(offsets[2], object.lastModifiedAt);
  writer.writeString(offsets[3], object.preview);
}
...
Note _noteDeserialize(
  ...
  object.id = id;
  object.lastModifiedAt = reader.readDateTime(offsets[2]);
  return object;
}
...
extension NoteQueryWhereSort on QueryBuilder<Note, Note, QWhere> {
  ...
  QueryBuilder<Note, Note, QAfterWhere> anyLastModifiedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'lastModifiedAt'),
      );
    });
  }
}
...
extension NoteQueryWhere on QueryBuilder<Note, Note, QWhereClause> {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> lastModifiedAtEqualTo(
      DateTime lastModifiedAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'lastModifiedAt',
        value: [lastModifiedAt],
      ));
    });
  }

  QueryBuilder<Note, Note, QAfterWhereClause> lastModifiedAtNotEqualTo(
      DateTime lastModifiedAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'lastModifiedAt',
              lower: [],
              upper: [lastModifiedAt],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'lastModifiedAt',
              lower: [lastModifiedAt],
              includeLower: false,
              upper: [],
            ));
      } else {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> lastModifiedAtGreaterThan(
    DateTime lastModifiedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> lastModifiedAtLessThan(
    DateTime lastModifiedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> lastModifiedAtBetween(
    DateTime lowerLastModifiedAt,
    DateTime upperLastModifiedAt, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'lastModifiedAt',
        lower: [lowerLastModifiedAt],
        includeLower: includeLower,
        upper: [upperLastModifiedAt],
        includeUpper: includeUpper,
      ));
    });
  }
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifiedAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifiedAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifiedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifiedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortByLastModifiedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModifiedAt', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByLastModifiedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByLastModifiedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModifiedAt', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByLastModifiedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModifiedAt', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctByLastModifiedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, DateTime, QQueryOperations> lastModifiedAtProperty() {
    return QueryBuilder.apply(this, (query) {
